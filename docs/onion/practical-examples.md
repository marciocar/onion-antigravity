...
Este guia apresenta cenários reais de uso dos workflows do Sistema Onion (`.agents/workflows/`) com exemplos detalhados e outputs esperados.
...
📁 Pasta criada: docs/sessions/auth-oauth2/
...
📄 Plano detalhado salvo em: docs/sessions/auth-oauth2/plan.md
```
...
📁 Sessão: docs/sessions/bug-dashboard-data/
...
#### **Passo 3: Fix Rápido**
```bash
/engineer-work docs/sessions/bug-dashboard-data/
```
...
📁 Sessão: docs/sessions/hotfix-payment-outage/
