...
Camada de abstração que permite trocar o gerenciador de tarefas (ClickUp, Asana, Jira, Linear) sem modificar os workflows do Sistema Onion.
...
### 2. Usar nos Workflows

```typescript
// Importar factory
import { getTaskManager } from 'docs/reference/task-manager/factory';
