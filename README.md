...
### Organize produto, engenharia e governança no mesmo ritmo — nativo do **Google Antigravity**.

[![Licença: MIT](https://img.shields.io/github/license/marciocar/onion-antigravity?color=success)](LICENSE)
![Plataforma](https://img.shields.io/badge/plataforma-Google_Antigravity-4285F4)
...
> [!NOTE]
> Esta é a porta **Google Antigravity** da família Onion — a mesma metodologia, expressa no primitivo nativo da plataforma. Conheça as outras 5 portas no hub: **[github.com/marciocar/onion](https://github.com/marciocar/onion)**.
...
1. Abra um projeto que já tenha o Onion instalado (`.agents/` + `AGENTS.md` na raiz) no **Antigravity**.
...
|---|---|---|
| Workflow | `/categoria-comando` | `/engineer-start`, `/product-collect` |
| Persona/especialista | via **Agent Manager** | `@product`, `@engineer`, `@compliance` |
...
- **Workflows faseados retomáveis** com Artifacts/sessões que permitem pausar e continuar.
...
| 🟣 **antigravity** | **Google Antigravity** | **◀ você está aqui** |
...
2. **Executar com apoio** de workflows padronizados e personas especializadas, em ciclos faseados retomáveis (`product-collect→feature` e `engineer-plan→pr-update`).
